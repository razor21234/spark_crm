            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="progress mb-3" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                        <div class="progress-bar progress-bar-striped  bg-primary" style="width: 10%">
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="progress progress-vertical progress-sm">
                        <div class="progress-bar bg-success" role="progressbar" style="height: 25%" aria-valuenow="25"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress progress-vertical">
                        <div class="progress-bar bg-info" role="progressbar" style="height: 50%" aria-valuenow="50"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress progress-vertical progress-lg">
                        <div class="progress-bar bg-warning" role="progressbar" style="height: 75%" aria-valuenow="75"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress progress-vertical progress-xl">
                        <div class="progress-bar bg-danger" role="progressbar" style="height: 90%" aria-valuenow="10"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
