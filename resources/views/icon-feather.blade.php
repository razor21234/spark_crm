                ...
                <div class="card-body">
                    <div class="icons-items">
                        <ul class="icons-list">
                            ...
                            <li><i class="fe fe-alert-octagon" data-bs-toggle="tooltip" title="fe fe-alert-octagon"></i>
                            </li>
                            <li><i class="fe fe-alert-triangle" data-bs-toggle="tooltip" title="fe fe-alert-triangle"></i>
                            </li>
                            <li><i class="fe fe-align-center" data-bs-toggle="tooltip" title="fe fe-align-center"></i></li>
                            <li><i class="fe fe-align-justify" data-bs-toggle="tooltip" title="fe fe-align-justify"></i>
                            </li>
                            ...
                            <li><i class="fe fe-arrow-down-circle" data-bs-toggle="tooltip"
                                    title="fe fe-arrow-down-circle"></i></li>
                            <li><i class="fe fe-arrow-down-left" data-bs-toggle="tooltip" title="fe fe-arrow-down-left"></i>
                            </li>
                            <li><i class="fe fe-arrow-down-right" data-bs-toggle="tooltip"
                                    title="fe fe-arrow-down-right"></i></li>
                            <li><i class="fe fe-arrow-left" data-bs-toggle="tooltip" title="fe fe-arrow-left"></i></li>
                            <li><i class="fe fe-arrow-left-circle" data-bs-toggle="tooltip"
                                    title="fe fe-arrow-left-circle"></i></li>
                            <li><i class="fe fe-arrow-right" data-bs-toggle="tooltip" title="fe fe-arrow-right"></i></li>
                            <li><i class="fe fe-arrow-right-circle" data-bs-toggle="tooltip"
                                    title="fe fe-arrow-right-circle"></i></li>
                            <li><i class="fe fe-arrow-up" data-bs-toggle="tooltip" title="fe fe-arrow-up"></i></li>
                            <li><i class="fe fe-arrow-up-circle" data-bs-toggle="tooltip" title="fe fe-arrow-up-circle"></i>
                            </li>
                            <li><i class="fe fe-arrow-up-left" data-bs-toggle="tooltip" title="fe fe-arrow-up-left"></i>
                            </li>
                            <li><i class="fe fe-arrow-up-right" data-bs-toggle="tooltip" title="fe fe-arrow-up-right"></i>
                            </li>
                            ...
                            <li><i class="fe fe-battery-charging" data-bs-toggle="tooltip"
                                    title="fe fe-battery-charging"></i></li>
                            ...
                            <li><i class="fe fe-check-circle" data-bs-toggle="tooltip" title="fe fe-check-circle"></i>
                            </li>
                            <li><i class="fe fe-check-square" data-bs-toggle="tooltip" title="fe fe-check-square"></i>
                            </li>
                            <li><i class="fe fe-chevron-down" data-bs-toggle="tooltip" title="fe fe-chevron-down"></i>
                            </li>
                            <li><i class="fe fe-chevron-left" data-bs-toggle="tooltip" title="fe fe-chevron-left"></i>
                            </li>
                            <li><i class="fe fe-chevron-right" data-bs-toggle="tooltip" title="fe fe-chevron-right"></i>
                            </li>
                            <li><i class="fe fe-chevron-up" data-bs-toggle="tooltip" title="fe fe-chevron-up"></i></li>
                            <li><i class="fe fe-chevrons-down" data-bs-toggle="tooltip" title="fe fe-chevrons-down"></i>
                            </li>
                            <li><i class="fe fe-chevrons-left" data-bs-toggle="tooltip" title="fe fe-chevrons-left"></i>
                            </li>
                            <li><i class="fe fe-chevrons-right" data-bs-toggle="tooltip"
                                    title="fe fe-chevrons-right"></i></li>
                            ...
                            <li><i class="fe fe-cloud-drizzle" data-bs-toggle="tooltip" title="fe fe-cloud-drizzle"></i>
                            </li>
                            <li><i class="fe fe-cloud-lightning" data-bs-toggle="tooltip"
                                    title="fe fe-cloud-lightning"></i></li>
                            ...
                            <li><i class="fe fe-corner-down-left" data-bs-toggle="tooltip"
                                    title="fe fe-corner-down-left"></i></li>
                            <li><i class="fe fe-corner-down-right" data-bs-toggle="tooltip"
                                    title="fe fe-corner-down-right"></i></li>
                            <li><i class="fe fe-corner-left-down" data-bs-toggle="tooltip"
                                    title="fe fe-corner-left-down"></i></li>
                            <li><i class="fe fe-corner-left-up" data-bs-toggle="tooltip"
                                    title="fe fe-corner-left-up"></i></li>
                            <li><i class="fe fe-corner-right-down" data-bs-toggle="tooltip"
                                    title="fe fe-corner-right-down"></i></li>
                            <li><i class="fe fe-corner-right-up" data-bs-toggle="tooltip"
                                    title="fe fe-corner-right-up"></i></li>
                            <li><i class="fe fe-corner-up-left" data-bs-toggle="tooltip"
                                    title="fe fe-corner-up-left"></i></li>
                            <li><i class="fe fe-corner-up-right" data-bs-toggle="tooltip"
                                    title="fe fe-corner-up-right"></i></li>
                            ...
                            <li><i class="fe fe-download-cloud" data-bs-toggle="tooltip"
                                    title="fe fe-download-cloud"></i></li>
                            ...
                            <li><i class="fe fe-external-link" data-bs-toggle="tooltip" title="fe fe-external-link"></i>
                            </li>
                            ...
                            <li><i class="fe fe-fast-forward" data-bs-toggle="tooltip" title="fe fe-fast-forward"></i>
                            </li>
                            ...
                            <li><i class="fe fe-folder-minus" data-bs-toggle="tooltip" title="fe fe-folder-minus"></i>
                            </li>
                            ...
                            <li><i class="fe fe-git-pull-request" data-bs-toggle="tooltip"
                                    title="fe fe-git-pull-request"></i></li>
                            ...
                            <li><i class="fe fe-message-circle" data-bs-toggle="tooltip"
                                    title="fe fe-message-circle"></i></li>
                            <li><i class="fe fe-message-square" data-bs-toggle="tooltip"
                                    title="fe fe-message-square"></i></li>
                            ...
                            <li><i class="fe fe-minus-circle" data-bs-toggle="tooltip" title="fe fe-minus-circle"></i>
                            </li>
                            <li><i class="fe fe-minus-square" data-bs-toggle="tooltip" title="fe fe-minus-square"></i>
                            </li>
                            ...
                            <li><i class="fe fe-more-horizontal" data-bs-toggle="tooltip"
                                    title="fe fe-more-horizontal"></i></li>
                            <li><i class="fe fe-more-vertical" data-bs-toggle="tooltip" title="fe fe-more-vertical"></i>
                            </li>
                            ...
                            <li><i class="fe fe-navigation-2" data-bs-toggle="tooltip" title="fe fe-navigation-2"></i>
                            </li>
                            ...
                            <li><i class="fe fe-pause-circle" data-bs-toggle="tooltip" title="fe fe-pause-circle"></i>
                            </li>
                            ...
                            <li><i class="fe fe-phone-forwarded" data-bs-toggle="tooltip"
                                    title="fe fe-phone-forwarded"></i></li>
                            <li><i class="fe fe-phone-incoming" data-bs-toggle="tooltip"
                                    title="fe fe-phone-incoming"></i></li>
                            <li><i class="fe fe-phone-missed" data-bs-toggle="tooltip" title="fe fe-phone-missed"></i>
                            </li>
                            <li><i class="fe fe-phone-off" data-bs-toggle="tooltip" title="fe fe-phone-off"></i></li>
                            <li><i class="fe fe-phone-outgoing" data-bs-toggle="tooltip"
                                    title="fe fe-phone-outgoing"></i></li>
                            ...
                            <li><i class="fe fe-shopping-bag" data-bs-toggle="tooltip" title="fe fe-shopping-bag"></i>
                            </li>
                            <li><i class="fe fe-shopping-cart" data-bs-toggle="tooltip" title="fe fe-shopping-cart"></i>
                            </li>
                            ...
                            <li><i class="fe fe-skip-forward" data-bs-toggle="tooltip" title="fe fe-skip-forward"></i>
                            </li>
                            ...
                            <li><i class="fe fe-toggle-right" data-bs-toggle="tooltip" title="fe fe-toggle-right"></i>
                            </li>
                            ...
                            <li><i class="fe fe-upload-cloud" data-bs-toggle="tooltip" title="fe fe-upload-cloud"></i>
                            </li>
