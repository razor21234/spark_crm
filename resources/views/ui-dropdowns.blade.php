    ...
    <div class="row">
                    ...
                    <div class="btn-list">
                        ...
                        <div class="btn-group">
                            <button class="btn btn-warning dropdown-toggle" type="button"
                                id="dropdownMenuClickableInsise" data-bs-toggle="dropdown" data-bs-auto-close="false"
                                aria-expanded="false">
                                Manual close
                            </button>
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change
        ...
        <div class="col-xl-3">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-title mb-3">Use <code>.dropdown-item-text.</code> to create non-interactive dropdown
                        items.</p>
        ...
        <div class="col-xl-3">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-title mb-3">Add a <code>.dropdown-header</code> to label sections of actions in any
                        dropdown menu.</p>
                    <div class="bd-example">
                        <ul class="dropdown-menu">
                            <li>
