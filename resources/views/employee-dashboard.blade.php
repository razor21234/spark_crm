                        ...
                        <div class="card-body">
                            <div class="welcome-info">
                                ...
                                <div class="welcome-img">
                                    <img src="{{ URL::asset('assets/img/avatar/avatar-19.jpg') }}" class="img-fluid"
                                        alt="User">
                                </div>
                            </div>
                            ...
                            <div class="holiday-details">
                                <div class="holiday-calendar">
                                    <div class="holiday-calendar-icon">
                                        <img src="{{ URL::asset('assets/img/icons/holiday-calendar.svg') }}" alt="Icon">
                                    </div>
                    ...
                    <div class="project-slider owl-carousel">
                        ...
                        <div class="project-grid">
                            <div class="project-top">
                                <h6>
                                    <a href="{{ url('project-view') }}">Deadline : 10 Feb 2024</a>
                                </h6>
                                <h5>
                                    <a href="{{ url('project-view') }}">Office Management</a>
                                </h5>
                                <p>Creating an online platform that enables various administrative tasks within an
                                    organization</p>
                            </div>
                            ...
                            <div class="project-bottom">
                                <div class="project-leader">
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                aria-label="Jeffery Lalor" data-bs-original-title="Jeffery Lalor">
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-19.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                ...
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-20.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                ...
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-21.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                aria-label="Loren Gatlin" data-bs-original-title="Loren Gatlin">
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-1.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                aria-label="Jeffery Lalor" data-bs-original-title="Jeffery Lalor">
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-16.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                aria-label="Tarah Shropshire" data-bs-original-title="Tarah Shropshire">
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-23.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                        <li>
                        ...
                        <div class="project-grid">
                            <div class="project-top">
                                <h6>
                                    <a href="{{ url('project-view') }}">Deadline : 15 Feb 2024</a>
                                </h6>
                                <h5>
                                    <a href="{{ url('project-view') }}">Video Calling App</a>
                                </h5>
                                <p>Design and developing a software application that enables users to make video calls over
                                    the internet.</p>
                            </div>
                            <div class="project-middle">
                                <ul class="nav">
                            ...
                            <div class="project-bottom">
                                <div class="project-leader">
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                aria-label="Catherine Manseau" data-bs-original-title="Catherine Manseau">
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-18.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div class="project-grid">
                            <div class="project-top">
                                <h6>
                                    <a href="{{ url('project-view') }}">Deadline : 12 Apr 2024</a>
                                </h6>
                                <h5>
                                    <a href="{{ url('project-view') }}">Hospital Administration</a>
                                </h5>
                                <p>Creating an online platform that serves as a central hub for hospital admin, staff,
                                    patients.</p>
                            </div>
                            <div class="project-middle">
                                <ul class="nav">
                        ...
                        <div class="project-grid">
                            <div class="project-top">
                                <h6>
                                    <a href="{{ url('project-view') }}">Deadline : 25 Apr 2024</a>
                                </h6>
                                <h5>
                                    <a href="{{ url('project-view') }}">Digital Marketpace</a>
                                </h5>
                                <p>Creating an online platform that connects sellers with buyers, facilitating the exchange
                                    of goods,</p>
                            </div>
                            <div class="project-middle">
                                <ul class="nav">
                                ...
                                <div class="project-leader">
                                    <ul class="nav">
                                        ...
                                        <li>
                                            <a href="{{ url('project-view') }}" data-bs-toggle="tooltip"
                                                aria-label="Loren Gatlin" data-bs-original-title="Loren Gatlin">
                                                <img src="{{ URL::asset('assets/img/avatar/avatar-26.jpg') }}"
                                                    alt="User">
                                            </a>
                                        </li>
                                        <li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-9 col-md-12">
                            <div class="employee-month-details">
                                ...
                                <p>We are really proud of the difference you have made which gives everybody the reason to
                    ...
                    <div class="company-slider owl-carousel">
                        ...
                        <div class="company-grid company-soft-tertiary">
                            <div class="company-top">
                                ...
                                <div class="company-link">
                                    <a href="{{ url('companies') }}">HR Policy</a>
                                </div>
                            </div>
                        ...
                        <div class="company-grid company-soft-success">
                            <div class="company-top">
                                ...
                                <div class="company-link">
                                    <a href="{{ url('companies') }}">Employer Policy</a>
                                </div>
                            </div>
                            <div class="company-bottom d-flex">
                                <ul>
                        ...
                        <div class="company-grid company-soft-info">
                            <div class="company-top">
                                ...
                                <div class="company-link">
                                    <a href="{{ url('companies') }}">Leave Policy</a>
                                </div>
                            </div>
                            <div class="company-bottom d-flex">
                                <ul>
