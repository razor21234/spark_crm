    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted mb-4">Use few flex utilities that allow even more flexibility and customization than
                        before.</p>
                    <div class="d-flex align-items-start text-muted mb-4">
                        <div class="flex-shrink-0 me-3">
                            <img src="{{ URL::asset('/assets/img/user-5.jpg') }}" class="avatar-sm rounded" alt="...">
                        </div>
                    ...
                    <div class="d-flex align-items-start text-muted mb-4">
                        ...
                        <div class="flex-shrink-0 ms-3">
                            <img src="{{ URL::asset('/assets/img/user-6.jpg') }}" class="avatar-sm rounded" alt="...">
                        </div>
                    </div>
                    <div class="d-flex align-items-start text-muted">
                        <div class="flex-shrink-0 me-3">
                            <img src="{{ URL::asset('/assets/img/user-7.jpg') }}" class="avatar-sm rounded" alt="...">
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="fs-14">Media heading</h5>
                            This is some content from a media component. You can replace this with any content and adjust it
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start text-muted mb-4">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-1">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
