                    ...
                    <div class="leave-info-box">
                        <div class="media d-flex align-items-center">
                            <a href="{{ url('profile') }}" class="avatar"><img alt=""
                                    src="{{ URL::asset('assets/img/user.jpg') }}"></a>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="#" class="avatar"><img src="{{ URL::asset('assets/img/profiles/avatar-19.jpg')}}"
                                                    alt="User Image"></a>
                                            <a href="{{ url('client-profile') }}">Barry Cuda <span>CEO</span></a>
                                        </h2>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="#" class="avatar"><img src="{{ URL::asset('assets/img/profiles/avatar-19.jpg')}}"
                                                    alt="User Image"></a>
                                            <a href="{{ url('client-profile') }}">Tressa Wexler <span>Manager</span></a>
                                        </h2>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{ url('client-profile') }}">Ruby Bartlett <span>CEO</span></a>
                                        </h2>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{ url('client-profile') }}"> Misty Tison <span>CEO</span></a>
                                        </h2>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="{{ url('client-profile') }}"> Daniel Deacon <span>CEO</span></a>
                                        </h2>
                                    </td>
                    ...
                    <div class="table-responsive">
                        <table class="table custom-table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <h2><a href="{{ url('project-view') }}">Office Management</a></h2>
                                ...
                                <tr>
                                    <td>
                                        <h2><a href="{{ url('project-view') }}">Project Management</a></h2>
                                        <small class="block text-ellipsis">
                                ...
                                <tr>
                                    <td>
                                        <h2><a href="{{ url('project-view') }}">Video Calling App</a></h2>
                                        <small class="block text-ellipsis">
                                ...
                                <tr>
                                    <td>
                                        <h2><a href="{{ url('project-view') }}">Hospital Administration</a></h2>
                                        <small class="block text-ellipsis">
                                ...
                                <tr>
                                    <td>
                                        <h2><a href="{{ url('project-view') }}">Digital Marketplace</a></h2>
                                        <small class="block text-ellipsis">
