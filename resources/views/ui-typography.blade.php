                ...
                <div class="card-body">
                    <figure class="blockquote-container">
                        <blockquote class="blockquote mb-2">
                            <h6>The greatest glory in living lies not in never falling, but in rising every time we fall.
                            </h6>
                        </blockquote>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <blockquote class="blockquote custom-blockquote primary text-center">
                                ...
                                <footer class="blockquote-footer mt-3 text-muted op-7 mb-0">Someone famous as <cite
            ...
            <div class="card bg-white">
                ...
                <div class="card-body">
                    <p class="text-muted mb-0">
                        Muted text with a <a href="#" class="text-reset text-decoration-underline text-dark">reset
                            link</a>.
                    </p>
                </div>
            </div>
