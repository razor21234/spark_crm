        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body card-buttons">
                    <p>SweetAlert automatically centers itself on the page and looks great no matter if you're using a
                        desktop
            ...
            <div class="card">
                ...
                <div class="card-body card-buttons">
                    <p>You can specify position of your alert with <code>position : { top-start | top-end | bottom-start |
                            bottom-end }</code> in js.</p>
            ...
            <div class="card">
                ...
                <div class="card-body card-buttons">
                    <p>The type of the modal. SweetAlert comes with 4 built-in types which will show a corresponding icon
                        animation:
                        "warning", "error", "success" and "info". You can also set it as "input" to get a prompt modal. It
                        can either
            ...
            <div class="card">
                ...
                <div class="card-body card-buttons">
                    ...
                    <button type="button" class="btn btn-outline-primary me-1 mb-1" id="outside-click">Click
                        Outside</button>
            ...
            <div class="card">
                ...
                <div class="card-body card-buttons">
                    ...
                    <p>Use <code>confirmButtonClass: "btn btn-{colorName}"</code> option to change the color of the
                        "Confirm" button.</p>
                    <button type="button" class="btn btn-outline-primary mb-0" id="confirm-color">Confirm Button
                        Color</button>
                </div>
            </div>
            <!-- \Confirm Options -->
