...
@section('content')
    ...
    <div class="row">
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <img src="{{ URL::asset('/assets/img/img-01.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h6 class="card-title fw-semibold">Card title</h6>
                    <p class="card-text text-muted">when an unknown printer took a galley of type and scrambled it to make a
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">There are many variations of passages of Lorem Ipsum available, but the majority
                        have suffered alteration many variations of passages of Lorem Ipsum available there are so many ways
                        to solve but the majority have suffered.</p>
                </div>
                <div class="card-footer">
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <img src="{{ URL::asset('/assets/img/img-02.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="card">
                <img src="{{ URL::asset('/assets/img/img-03.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h6 class="card-title fw-semibold">Card title</h6>
                    <p class="card-text">Some quick example text to build on the card title and
                        make up the bulk of the card's content.</p>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <blockquote class="blockquote mb-0 text-center">
                                <h6 class="">The greatest glory in living lies not in never falling, but in rising
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-12">
            ...
            <div class="row row-cols-12">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <img src="{{ URL::asset('/assets/img/img-04.jpg') }}" class="card-img mb-3" alt="...">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <img src="{{ URL::asset('/assets/img/img-05.jpg') }}" class="card-img mb-3" alt="...">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <img src="{{ URL::asset('/assets/img/img-02.jpg') }}" class="card-img mb-3" alt="...">
                        ...
                        <div class="card-body">
                            <div class="mb-2">
                                <span class="avatar avatar-md">
                                    <img src="{{ URL::asset('/assets/img/img-01.jpg') }}" alt="img">
                                </span>
                            </div>
                            <h6 class="card-title fw-semibold">Where it come from</h6>
                            <p class="card-text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has
                ...
                <div class="col-xl-4">
                    <div class="card text-center">
                        <div class="card-body">
                            <div class="mb-2">
                                <span class="avatar avatar-md">
                                    <img src="{{ URL::asset('/assets/img/img-02.jpg') }}" alt="img">
                                </span>
                            </div>
                            <h6 class="card-title fw-semibold">Why do we use it?</h6>
                            <p class="card-text">Many desktop publishing packages and web page editors now use Lorem Ipsum
                ...
                <div class="col-xl-4">
                    <div class="card text-end">
                        <div class="card-body">
                            <div class="mb-2">
                                <span class="avatar avatar-md">
                                    <img src="{{ URL::asset('/assets/img/img-03.jpg') }}" alt="img">
                                </span>
                            </div>
    ...
    <div class="row">
            ...
            <div class="card text-center">
                ...
                <div class="card-body pt-1">
                    <span class="avatar avatar-xl avatar-rounded me-2 mb-2">
                        <img src="{{ URL::asset('/assets/img/avatar/avatar-7.jpg') }}" alt="img">
                    </span>
        ...
        <div class="col-xl-2">
            <div class="card">
                <div class="card-body">
                    <img src="{{ URL::asset('/assets/img/img-1.jpg') }}" class="card-img mb-3" alt="...">
        ...
        <div class="col-xl-2">
            <div class="card">
                <div class="card-body">
                    <img src="{{ URL::asset('/assets/img/img-2.jpg') }}" class="card-img mb-3" alt="...">
        ...
        <div class="col-xl-2">
            <div class="card">
                <div class="card-body">
                    <img src="{{ URL::asset('/assets/img/img-3.jpg') }}" class="card-img mb-3" alt="...">
        ...
        <div class="col-xl-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0 card-text">Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact
            ...
            <div class="card">
                ...
                <div class="collapse show" id="collapseExample">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-0">There are many variations of passages of Lorem Ipsum available, but the
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text mb-3 text-muted">But I must explain to you how all this mistaken idea of denouncing
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <img src="{{ URL::asset('/assets/img/img-02.jpg') }}" class="card-img-bottom" alt="...">
            </div>
        </div>
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-1 text-muted">This is a wider card with supporting text below as a natural
                        lead-in to additional content. This content is a little bit longer.</p>
                </div>
                <img src="{{ URL::asset('/assets/img/img-2.jpg') }}" class="card-img rounded-0" alt="...">
                <div class="card-body">
                    <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                </div>
            </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <img src="{{ URL::asset('/assets/img/img-04.jpg') }}" class="card-img rounded-0" alt="...">
                <div class="card-footer">
                    <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
                </div>
            </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <img src="{{ URL::asset('/assets/img/img-05.jpg') }}" class="card-img-top" alt="...">
                <div class="card-header">
                    <div class="card-title">Image caps are widely used in Blog's</div>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-4">
            <div class="card">
                ...
                <img src="{{ URL::asset('/assets/img/img-1.jpg') }}" class="card-img-bottom" alt="...">
            </div>
        </div>
    </div>
    <!-- /Image Caps -->
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card overlay-card">
                <img src="{{ URL::asset('/assets/img/img-2.jpg') }}" class="card-img" alt="...">
                <div class="card-img-overlay d-flex flex-column p-0">
                    ...
                    <div class="card-body text-fixed-white">
                        <div class="card-text mb-2">There are many variations of passages of Lorem Ipsum available, but the
        ...
        <div class="col-xl-4">
            <div class="card overlay-card">
                <img src="{{ URL::asset('/assets/img/img-3.jpg') }}" class="card-img" alt="...">
        ...
        <div class="col-xl-4">
            <div class="card overlay-card">
                <img src="{{ URL::asset('/assets/img/img-4.jpg') }}" class="card-img" alt="...">
                <div class="card-img-overlay d-flex flex-column p-0">
                    <div class="card-header">
                        <div class="card-title text-fixed-white">
                            Image Overlays Are Awesome!
                    ...
                    <div class="card-body text-fixed-white">
                        <div class="card-text">There are many variations of passages of Lorem Ipsum available, but the
                            majority have suffered alteration in some form, by injected humour, or randomised words which
                            don't look even.</div>
                    </div>
                    <div class="card-footer text-fixed-white">Last updated 3 mins ago</div>
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="{{ URL::asset('/assets/img/img-05.jpg') }}"
            ...
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-8">
                        ...
                        <div class="card-body">
                            <h6 class="card-title fw-semibold">Horizontal cards are awesome!</h6>
                            <p class="card-text mb-3">This is a wider card with suppo rting text below as a natural lead-in
                                to additional content. This content is a little bit longer.</p>
                            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <img src="{{ URL::asset('/assets/img/img-01.jpg') }}"
            ...
            <div class="card card-bg-success">
                <div class="card-body">
                    <div class="d-flex align-items-center w-100">
                        <div class="me-2">
                            <span class="avatar avatar-rounded">
                                <img src="{{ URL::asset('/assets/img/avatar/avatar-11.jpg') }}" alt="img">
                            </span>
                        </div>
                        <div class="">
            ...
            <div class="card card-bg-danger">
                <div class="card-body">
                    <div class="d-flex align-items-center w-100">
                        <div class="me-2">
                            <span class="avatar avatar-rounded">
                                <img src="{{ URL::asset('/assets/img/avatar/avatar-4.jpg') }}" alt="img">
                            </span>
                        </div>
                        <div class="">
            ...
            <div class="card card-bg-light">
                <div class="card-body">
                    <div class="d-flex align-items-center w-100">
                        <div class="me-2">
                            <span class="avatar avatar-rounded">
                                <img src="{{ URL::asset('/assets/img/avatar/avatar-5.jpg') }}" alt="img">
                            </span>
                        </div>
                        <div class="">
            ...
            <div class="card card-bg-dark">
                <div class="card-body">
                    <div class="d-flex align-items-center w-100">
                        <div class="me-2">
                            <span class="avatar avatar-rounded">
                                <img src="{{ URL::asset('/assets/img/avatar/avatar-6.jpg') }}" alt="img">
                            </span>
                        </div>
                        <div class="">
            ...
            <div class="card border border-warning">
                <div class="card-body">
                    ...
                    <div class="avatar-list-stacked">
                        ...
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-8.jpg') }}" alt="img">
                        </span>
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-9.jpg') }}" alt="img">
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3">
            <div class="card border border-info">
                <div class="card-body">
                    ...
                    <div class="avatar-list-stacked">
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-10.jpg') }}" alt="img">
                        </span>
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-11.jpg') }}" alt="img">
                        </span>
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-12.jpg') }}" alt="img">
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3">
            <div class="card border border-danger">
                <div class="card-body">
                    ...
                    <div class="avatar-list-stacked">
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-13.jpg') }}" alt="img">
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3">
            <div class="card border border-success">
                <div class="card-body">
                    ...
                    <div class="avatar-list-stacked">
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-14.jpg') }}" alt="img">
                        </span>
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-15.jpg') }}" alt="img">
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card border border-light">
                <div class="card-body">
                    ...
                    <div class="avatar-list-stacked">
                        ...
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-17.jpg') }}" alt="img">
                        </span>
                        <span class="avatar avatar-sm avatar-rounded">
                            <img src="{{ URL::asset('/assets/img/avatar/avatar-18.jpg') }}" alt="img">
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
                        ...
                        <div class="row g-0">
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text mb-0">This is a wild animal with supporting tactics and are very
                                        efficient at kill,they are very Dangerous.</p>
                            ...
                            <div class="col-md-4">
                                <img src="{{ URL::asset('/assets/img/img-5.jpg') }}"
        ...
        <div class="col-xxl-3 col-xl-6">
            <div class="card">
                <a href="javascript:void(0);" class="card-anchor"></a>
                <img src="{{ URL::asset('/assets/img/img-4.jpg') }}" class="card-img-top" alt="...">
                <div class="card-body">
                    <h6 class="card-title fw-semibold">Most tropical areas are suitable</h6>
                    <p class="card-text"> If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div class="col">
                    <div class="card">
                        <img src="{{ URL::asset('/assets/img/img-04.jpg') }}" class="card-img-top" alt="...">
                        <div class="card-body">
