    ...
    <div class="sidebar sidebar-twocol" id="navbar-nav">
        <div class="sidebar-left slimscroll">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <a class="nav-link {{ Request::is('admin-dashboard','employee-dashboard','deals-dashboard','leads-dashboard') ? 'active' : '' }}" id="v-pills-dashboard-tab" title="Dashboard" data-bs-toggle="pill" href="#v-pills-dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="true">
                ...
                <a class="nav-link {{ Request::is('employees-list','employees','holidays','leaves','leaves-employee','leave-settings','attendance','attendance-employee','departments','designations','timesheet','shift-scheduling','overtime','shift-list') ? 'active' : '' }}" id="v-pills-employees-tab" title="Employees" data-bs-toggle="pill" href="#v-pills-employees" role="tab" aria-controls="v-pills-employees" aria-selected="false">
                    <span class="material-icons-outlined">
                        people
                    </span>
                </a>
                <a class="nav-link {{ Request::is('clients','clients-list') ? 'active' : '' }}" id="v-pills-clients-tab" title="Clients" data-bs-toggle="pill" href="#v-pills-clients" role="tab" aria-controls="v-pills-clients" aria-selected="false">
                    <span class="material-icons-outlined">
                        person
                    </span>
                </a>
                <a class="nav-link {{ Request::is('projects','tasks','task-board','project-list') ? 'active' : '' }}" id="v-pills-projects-tab" title="Projects" data-bs-toggle="pill" href="#v-pills-projects" role="tab" aria-controls="v-pills-projects" aria-selected="false">
                    <span class="material-icons-outlined">
                        topic
                    </span>
                </a>
                <a class="nav-link {{ Request::is('contact-list','companies','deals','leads','leads-details','leads-kanban','pipeline','analytics','contact-grid','contact-details','companies-grid','company-details','deals-kanban','deals-details') ? 'active' : '' }}" id="v-pills-leads-tab" title="CRM" data-bs-toggle="pill" href="#v-pills-leads" role="tab" aria-controls="v-pills-leads" aria-selected="false">
                    <span class="material-icons-outlined">
                        leaderboard
                    </span>
                </a>
                <a class="nav-link {{ Request::is('tickets','ticket-details') ? 'active' : '' }}" id="v-pills-tickets-tab" title="Tickets" data-bs-toggle="pill" href="#v-pills-tickets" role="tab" aria-controls="v-pills-tickets" aria-selected="false">
                    <span class="material-icons-outlined">
                        confirmation_number
                    </span>
                </a>
                <a class="nav-link {{ Request::is('estimates','invoices','payments','expenses','provident-fund','taxes','edit-estimate','create-invoice','edit-invoice','create-estimate') ? 'active' : '' }}" id="v-pills-sales-tab" title="Sales" data-bs-toggle="pill" href="#v-pills-sales" role="tab" aria-controls="v-pills-sales" aria-selected="false">
                    <span class="material-icons-outlined">
                        shopping_bag
                    </span>
                </a>
                <a class="nav-link {{ Request::is('categories','budgets','budget-expenses','budget-revenues','sub-category') ? 'active' : '' }}" id="v-pills-accounting-tab" title="Accounting" data-bs-toggle="pill" href="#v-pills-accounting" role="tab" aria-controls="v-pills-accounting" aria-selected="false">
                    <span class="material-icons-outlined">
                        account_balance_wallet
                    </span>
                </a>
                <a class="nav-link {{ Request::is('salary','salary-view','payroll-items') ? 'active' : '' }}" id="v-pills-payroll-tab" title="Payroll" data-bs-toggle="pill" href="#v-pills-payroll" role="tab" aria-controls="v-pills-payroll" aria-selected="false">
                    <span class="material-icons-outlined">
                        request_quote
                    </span>
                </a>
                <a class="nav-link {{ Request::is('policies') ? 'active' : '' }}" id="v-pills-policies-tab" title="Policies" data-bs-toggle="pill" href="#v-pills-policies" role="tab" aria-controls="v-pills-policies" aria-selected="false">
                    <span class="material-icons-outlined">
                        verified_user
                    </span>
                </a>
                <a class="nav-link {{ Request::is('expense-reports','invoice-reports','payments-reports','task-reports','user-reports','employee-reports','payslip-reports','attendance-reports','leave-reports','daily-reports','project-reports') ? 'active' : '' }}" id="v-pills-reports-tab" title="Reports" data-bs-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false">
                    <span class="material-icons-outlined">
                        report_gmailerrorred
                    </span>
                </a>
                <a class="nav-link {{ Request::is('performance-indicator','performance','performance-appraisal') ? 'active' : '' }}" id="v-pills-performance-tab" title="Performance" data-bs-toggle="pill" href="#v-pills-performance" role="tab" aria-controls="v-pills-performance" aria-selected="false">
                    <span class="material-icons-outlined">
                        shutter_speed
                    </span>
                </a>
                <a class="nav-link {{ Request::is('goal-tracking','goal-type') ? 'active' : '' }}" id="v-pills-goals-tab" title="Goals" data-bs-toggle="pill" href="#v-pills-goals" role="tab" aria-controls="v-pills-goals" aria-selected="false">
                    <span class="material-icons-outlined">
                        track_changes
                    </span>
                </a>
                <a class="nav-link {{ Request::is('training','trainers','training-type') ? 'active' : '' }}" id="v-pills-training-tab" title="Training" data-bs-toggle="pill" href="#v-pills-training" role="tab" aria-controls="v-pills-training" aria-selected="false">
                    <span class="material-icons-outlined">
                        checklist_rtl
                    </span>
                </a>
                <a class="nav-link {{ Request::is('promotion') ? 'active' : '' }}" id="v-pills-promotion-tab" title="Promotions" data-bs-toggle="pill" href="#v-pills-promotion" role="tab" aria-controls="v-pills-promotion" aria-selected="false">
                    <span class="material-icons-outlined">
                        auto_graph
                    </span>
                </a>
                <a class="nav-link {{ Request::is('resignation') ? 'active' : '' }}" id="v-pills-resignation-tab" title="Resignation" data-bs-toggle="pill" href="#v-pills-resignation" role="tab" aria-controls="v-pills-resignation" aria-selected="false">
                    <span class="material-icons-outlined">
                        do_not_disturb_alt
                    </span>
                </a>
                <a class="nav-link {{ Request::is('termination') ? 'active' : '' }}" id="v-pills-termination-tab" title="Termination" data-bs-toggle="pill" href="#v-pills-termination" role="tab" aria-controls="v-pills-termination" aria-selected="false">
                    <span class="material-icons-outlined">
                        indeterminate_check_box
                    </span>
                </a>
                <a class="nav-link {{ Request::is('assets1') ? 'active' : '' }}" id="v-pills-assets-tab" title="Assets" data-bs-toggle="pill" href="#v-pills-assets" role="tab" aria-controls="v-pills-assets" aria-selected="false">
                    <span class="material-icons-outlined">
                        web_asset
                    </span>
                </a>
                <a class="nav-link {{ Request::is('user-dashboard','jobs-dashboard','jobs','job-applicants','manage-resumes','shortlist-candidates','interview-questions','offer_approvals','experiance-level','candidates','schedule-timing','apptitude-result','user-all-jobs','saved-jobs','applied-jobs','interviewing','offered-jobs','visited-jobs','archived-jobs','job-aptitude','questions') ? 'active' : '' }}" id="v-pills-jobs-tab" title="Jobs" data-bs-toggle="pill" href="#v-pills-jobs" role="tab" aria-controls="v-pills-jobs" aria-selected="false">
                    <span class="material-icons-outlined">
                        work_outline
                    </span>
                </a>
                <a class="nav-link {{ Request::is('knowledgebase','knowledgebase-view') ? 'active' : '' }} " id="v-pills-knowledgebase-tab" title="Knowledgebase" data-bs-toggle="pill" href="#v-pills-knowledgebase" role="tab" aria-controls="v-pills-knowledgebase" aria-selected="false">
                    <span class="material-icons-outlined">
                        school
                    </span>
                </a>
                <a class="nav-link {{ Request::is('activities') ? 'active' : '' }} " id="v-pills-activities-tab" title="Activities" data-bs-toggle="pill" href="#v-pills-activities" role="tab" aria-controls="v-pills-activities" aria-selected="false">
                    <span class="material-icons-outlined">
                        toggle_off
                    </span>
                </a>
                <a class="nav-link {{ Request::is('users') ? 'active' : '' }}" id="v-pills-users-tab" title="Users" data-bs-toggle="pill" href="#v-pills-users" role="tab" aria-controls="v-pills-users" aria-selected="false">
                    <span class="material-icons-outlined">
                        group_add
                    </span>
                </a>
                <a class="nav-link {{ Request::is('settings','localization','theme-settings','roles-permissions','email-settings','performance-setting','approval-setting','invoice-settings','salary-settings','notifications-settings','change-password','leave-type','toxbox-setting','cron-setting') ? 'active' : '' }}" id="v-pills-settings-tab" title="Settings" data-bs-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                    <span class="material-icons-outlined">
                        settings
                    </span>
                </a>
                <a class="nav-link {{ Request::is('profile','client-profile','user-asset-details') ? 'active' : '' }}" id="v-pills-profile-tab" title="Profile" data-bs-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                    <span class="material-icons-outlined">
                        manage_accounts
                    </span>
                </a>
                <a class="nav-link {{ Request::is('index','register','forgot-password','otp','lock-screen') ? 'active' : '' }}" id="v-pills-authentication-tab" title="Authentication" data-bs-toggle="pill" href="#v-pills-authentication" role="tab" aria-controls="v-pills-authentication" aria-selected="false">
                    <span class="material-icons-outlined">
                        perm_contact_calendar
                    </span>
                </a>
                <a class="nav-link {{ Request::is('error-404','error-500') ? 'active' : '' }}" id="v-pills-errorpages-tab" title="Error Pages" data-bs-toggle="pill" href="#v-pills-errorpages" role="tab" aria-controls="v-pills-errorpages" aria-selected="false">
                    <span class="material-icons-outlined">
                        announcement
                    </span>
                </a>
                <a class="nav-link {{ Request::is('subscriptions','subscriptions-company','subscribed-companies') ? 'active' : '' }}" id="v-pills-subscriptions-tab" title="Subscriptions" data-bs-toggle="pill" href="#v-pills-subscriptions" role="tab" aria-controls="v-pills-subscriptions" aria-selected="false">
                    <span class="material-icons-outlined">
                        loyalty
                    </span>
                </a>
                <a class="nav-link {{ Request::is('search','faq','terms','privacy-policy','blank-page','coming-soon','under-maintenance') ? 'active' : '' }}" id="v-pills-pages-tab" title="Pages" data-bs-toggle="pill" href="#v-pills-pages" role="tab" aria-controls="v-pills-pages" aria-selected="false">
                    <span class="material-icons-outlined">
                        layers
                    </span>
                </a>
                <a class="nav-link {{ Request::is('ui-alerts','ui-accordion','ui-avatar','ui-badges','ui-borders','ui-buttons','ui-buttons-group','ui-breadcrumb','ui-cards','ui-carousel',
                'ui-colors', 'ui-dropdowns','ui-grid','ui-images','ui-lightbox','ui-media','ui-modals','ui-notification','ui-offcanvas','ui-pagination','ui-popovers','ui-progress',
                'ui-placeholders' ,'ui-rangeslider','ui-spinner','ui-sweetalerts','ui-nav-tabs','ui-toasts','ui-tooltips','ui-typography','ui-video') ? 'active' : '' }}" id="v-pills-baseui-tab" title="Base UI" data-bs-toggle="pill" href="#v-pills-baseui" role="tab" aria-controls="v-pills-baseui" aria-selected="false">
                    <span class="material-icons-outlined">
                        foundation
                    </span>
                </a>
                <a class="nav-link {{ Request::is('ui-ribbon','ui-clipboard','ui-drag-drop','ui-rangeslider','ui-rating','ui-text-editor','ui-counter','ui-scrollbar','ui-stickynote','ui-timeline') ? 'active' : '' }}" id="v-pills-elements-tab" title="Advanced UI" data-bs-toggle="pill" href="#v-pills-elements" role="tab" aria-controls="v-pills-elements" aria-selected="false">
                    <span class="material-icons-outlined">
                        bento
                    </span>
                </a>
                <a class="nav-link  {{ Request::is('chart-apex','chart-js','chart-morris','chart-flot','chart-peity','chart-c3') ? 'active' : '' }}" id="v-pills-charts-tab" title="Charts" data-bs-toggle="pill" href="#v-pills-charts" role="tab" aria-controls="v-pills-charts" aria-selected="false">
                    <span class="material-icons-outlined">
                        bar_chart
                    </span>
                </a>
                <a class="nav-link {{ Request::is('icon-fontawesome','icon-feather','icon-ionic','icon-material','icon-pe7','icon-simpleline','icon-themify','icon-weather','icon-typicon','icon-flag') ? 'active' : '' }}" id="v-pills-icons-tab" title="Icons" data-bs-toggle="pill" href="#v-pills-icons" role="tab" aria-controls="v-pills-icons" aria-selected="false">
                    <span class="material-icons-outlined">
                        grading
                    </span>
                </a>
                <a class="nav-link {{ Request::is('form-basic-inputs','form-input-groups','form-horizontal','form-vertical','form-mask','form-validation','form-select2','form-fileupload','horizontal-timeline','form-wizard') ? 'active' : '' }}" id="v-pills-forms-tab" title="Forms" data-bs-toggle="pill" href="#v-pills-forms" role="tab" aria-controls="v-pills-forms" aria-selected="false">
                    <span class="material-icons-outlined">
                        view_day
                    </span>
                </a>
                <a class="nav-link {{ Request::is('tables-basic','data-tables') ? 'active' : '' }}" id="v-pills-tables-tab" title="Tables" data-bs-toggle="pill" href="#v-pills-tables" role="tab" aria-controls="v-pills-tables" aria-selected="false">
                    <span class="material-icons-outlined">
                        table_rows
                    </span>
                </a>
        ...
        <div class="sidebar-right">
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show  {{ Request::is('admin-dashboard','employee-dashboard','deals-dashboard','leads-dashboard') ? 'active' : '' }}" id="v-pills-dashboard" role="tabpanel" aria-labelledby="v-pills-dashboard-tab">
                    <p>Dashboard</p>
                    <ul>
                        <li>
                            <a  class="{{ Request::is('admin-dashboard') ? 'active' : '' }}" href="{{url('admin-dashboard')}}" >Admin Dashboard</a>
                        </li>
                        <li>
                ...
                <div class="tab-pane fade" id="v-pills-apps" role="tabpanel" aria-labelledby="v-pills-apps-tab">
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="{{ Request::is('contacts') ? 'active' : '' }}" href="{{url('contacts')}}">Contacts</a>
                        </li>
                        <li>
                            <a class="{{ Request::is('inbox') ? 'active' : '' }}" href="{{url('inbox')}}">Email</a>
                        </li>
                        <li>
                            <a class="{{ Request::is('file-manager') ? 'active' : '' }}" href="{{url('file-manager')}}">File Manager</a>
                        </li>
                    </ul>						
                </div>
                <div class="tab-pane fade show {{ Request::is('employees-list','employees','holidays','leaves','leaves-employee','leave-settings','attendance','attendance-employee','departments','designations','timesheet','shift-scheduling','overtime','shift-list') ? 'active' : '' }}" id="v-pills-employees" role="tabpanel" aria-labelledby="v-pills-employees-tab">
                    <p>Employees</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('clients','clients-list') ? 'active' : '' }}" id="v-pills-clients" role="tabpanel" aria-labelledby="v-pills-clients-tab">
                    <p>Clients</p>
                    <ul>
                        <li><a    class="{{ Request::is('clients','clients-list') ? 'active' : '' }}" href="{{url('clients')}}">Clients</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('projects','tasks','task-board','project-list') ? 'active' : '' }}"  id="v-pills-projects" role="tabpanel" aria-labelledby="v-pills-projects-tab">
                    <p>Projects</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('contact-list','companies','deals','leads','leads-details','leads-kanban','pipeline','analytics','contact-grid','contact-details','companies-grid','company-details','deals-kanban','deals-details') ? 'active' : '' }}" id="v-pills-leads" role="tabpanel" aria-labelledby="v-pills-leads-tab">
                    <p>CRM</p>
                    <ul>
                        <li>
                            <a class="{{ Request::is('contact-list','contact-grid','contact-details') ? 'active' : '' }}"  href="{{url('contact-list')}}"> Contacts</a>
                        </li>
                        <li>
                            <a class="{{ Request::is('companies','companies-grid','company-details') ? 'active' : '' }}" href="{{url('companies')}}">Companies</a>
                        </li>
                        <li>
                            <a class="{{ Request::is('deals','deals-kanban','deals-details') ? 'active' : '' }}"  href="{{url('deals')}}">  Deals</a>
                        </li>
                        <li>
                            <a class="{{ Request::is('leads','leads-details','leads-kanban') ? 'active' : '' }}" href="{{url('leads')}}"> Leads </a>
                        </li>
                        <li>
                ...
                <div class="tab-pane fade show {{ Request::is('tickets','ticket-details') ? 'active' : '' }}" id="v-pills-tickets" role="tabpanel" aria-labelledby="v-pills-tickets-tab">
                    <p>Tickets</p>
                    <ul>
                        <li><a    class="{{ Request::is('tickets') ? 'active' : '' }}" href="{{url('tickets')}}">Tickets</a></li>
                        <li><a    class="{{ Request::is('ticket-details') ? 'active' : '' }}"href="{{url('ticket-details')}}">Ticket Details</a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('estimates','invoices','payments','expenses','provident-fund','taxes','edit-estimate','create-invoice','edit-invoice','create-estimate') ? 'active' : '' }}" id="v-pills-sales" role="tabpanel" aria-labelledby="v-pills-sales-tab">
                    <p>Sales</p>
                    <ul>
                        <li><a    class="{{ Request::is('estimates','edit-estimate','create-estimate') ? 'active' : '' }}"href="{{url('estimates')}}">Estimates</a></li>
                ...
                <div class="tab-pane fade show {{ Request::is('categories','budgets','budget-expenses','budget-revenues','sub-category') ? 'active' : '' }}" id="v-pills-accounting" role="tabpanel" aria-labelledby="v-pills-accounting-tab">
                    <p>Accounting</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('salary','salary-view','payroll-items') ? 'active' : '' }}" id="v-pills-payroll" role="tabpanel" aria-labelledby="v-pills-payroll-tab">
                    <p>Payroll</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('policies') ? 'active' : '' }}" id="v-pills-policies" role="tabpanel" aria-labelledby="v-pills-policies-tab">
                    <p>Policies</p>
                    <ul>
                        <li><a    class="{{ Request::is('policies') ? 'active' : '' }}"href="{{url('policies')}}"> Policies </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('expense-reports','invoice-reports','payments-reports','task-reports','user-reports','employee-reports','payslip-reports','attendance-reports','leave-reports','daily-reports','project-reports') ? 'active' : '' }}" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
                    <p>Reports</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('performance-indicator','performance','performance-appraisal') ? 'active' : '' }}" id="v-pills-performance" role="tabpanel" aria-labelledby="v-pills-performance-tab">
                    <p>Performance</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('goal-tracking','goal-type') ? 'active' : '' }}" id="v-pills-goals" role="tabpanel" aria-labelledby="v-pills-goals-tab">
                    <p>Goals</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('training','trainers','training-type') ? 'active' : '' }} " id="v-pills-training" role="tabpanel" aria-labelledby="v-pills-training-tab">
                    <p>Training</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('promotion') ? 'active' : '' }}" id="v-pills-promotion" role="tabpanel" aria-labelledby="v-pills-promotion-tab">
                    <p>Promotion</p>
                    <ul>
                        <li><a    class="{{ Request::is('promotion') ? 'active' : '' }}"href="{{url('promotion')}}"> Promotion </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('resignation') ? 'active' : '' }}" id="v-pills-resignation" role="tabpanel" aria-labelledby="v-pills-resignation-tab">
                    <p>Resignation</p>
                    <ul>
                        <li><a    class="{{ Request::is('resignation') ? 'active' : '' }}"href="{{url('resignation')}}"> Resignation </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('termination') ? 'active' : '' }}" id="v-pills-termination" role="tabpanel" aria-labelledby="v-pills-termination-tab">
                    <p>Termination</p>
                    <ul>
                        <li><a    class="{{ Request::is('termination') ? 'active' : '' }}"href="{{url('termination')}}"> Termination </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('assets1') ? 'active' : '' }} " id="v-pills-assets" role="tabpanel" aria-labelledby="v-pills-assets-tab">
                    <p>Assets</p>
                    <ul>
                        <li><a    class="{{ Request::is('assets1') ? 'active' : '' }}"href="{{url('assets1')}}"> Assets </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('user-dashboard','jobs-dashboard','jobs','job-applicants','manage-resumes','shortlist-candidates','interview-questions','offer_approvals','experiance-level','candidates','schedule-timing','apptitude-result','user-all-jobs','saved-jobs','applied-jobs','interviewing','offered-jobs','visited-jobs','archived-jobs','job-aptitude','questions') ? 'active' : '' }} " id="v-pills-jobs" role="tabpanel" aria-labelledby="v-pills-jobs-tab">
                    <p>Jobs</p>
                    <ul>
                        <li><a    class="{{ Request::is('user-dashboard','user-all-jobs','saved-jobs','applied-jobs','interviewing','offered-jobs','visited-jobs','archived-jobs','job-aptitude','questions') ? 'active' : '' }}"href="{{url('user-dashboard')}}" class="active"> User Dasboard </a></li>
                        ...
                        <li><a    class="{{ Request::is('job-applicants') ? 'active' : '' }}"href="{{url('job-applicants')}}"> Applied Jobs </a></li>
                ...
                <div class="tab-pane fade show {{ Request::is('knowledgebase','knowledgebase-view') ? 'active' : '' }}" id="v-pills-knowledgebase" role="tabpanel" aria-labelledby="v-pills-knowledgebase-tab">
                    <p>Knowledgebase</p>
                    <ul>
                        <li><a    class="{{ Request::is('knowledgebase','knowledgebase-view') ? 'active' : '' }}"href="{{url('knowledgebase')}}"> Knowledgebase </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('activities') ? 'active' : '' }}" id="v-pills-activities" role="tabpanel" aria-labelledby="v-pills-activities-tab">
                    <p>Activities</p>
                    <ul>
                        <li><a    class="{{ Request::is('activities') ? 'active' : '' }}"href="{{url('activities')}}"> Activities </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('users') ? 'active' : '' }}" id="v-pills-users" role="tabpanel" aria-labelledby="v-pills-activities-tab">
                    <p>Users</p>
                    <ul>
                        <li><a    class="{{ Request::is('users') ? 'active' : '' }}"href="{{url('users')}}"> Users </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('settings','localization','theme-settings','roles-permissions','email-settings','performance-setting','approval-setting','invoice-settings','salary-settings','notifications-settings','change-password','leave-type','toxbox-setting','cron-setting') ? 'active' : '' }}" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                    <p>Settings</p>
                    <ul>
                        <li><a    class="{{ Request::is('settings','localization','theme-settings','roles-permissions','email-settings','performance-setting','approval-setting','invoice-settings','salary-settings','notifications-settings','change-password','leave-type','toxbox-setting','cron-setting') ? 'active' : '' }}"href="{{url('settings')}}"> Settings </a></li>
                    </ul>
                </div>
                <div class="tab-pane fade show {{ Request::is('profile','client-profile','user-asset-details') ? 'active' : '' }}" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                    <p>Profile</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('index','register','forgot-password','otp','lock-screen') ? 'active' : '' }} " id="v-pills-authentication" role="tabpanel" aria-labelledby="v-pills-authentication-tab">
                    <p>Authentication</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('error-404','error-500') ? 'active' : '' }}" id="v-pills-errorpages" role="tabpanel" aria-labelledby="v-pills-errorpages-tab">
                    <p>Error Pages</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('subscriptions','subscriptions-company','subscribed-companies') ? 'active' : '' }}" id="v-pills-subscriptions" role="tabpanel" aria-labelledby="v-pills-subscriptions-tab">
                    <p>Subscriptions</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('search','faq','terms','privacy-policy','blank-page','coming-soon','under-maintenance') ? 'active' : '' }}" id="v-pills-pages" role="tabpanel" aria-labelledby="v-pills-pages-tab">
                    <p>Pages</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('ui-alerts','ui-accordion','ui-avatar','ui-badges','ui-borders','ui-buttons','ui-buttons-group','ui-breadcrumb','ui-cards','ui-carousel',
              'ui-colors', 'ui-dropdowns','ui-grid','ui-images','ui-lightbox','ui-media','ui-modals','ui-notification','ui-offcanvas','ui-pagination','ui-popovers','ui-progress',
              'ui-placeholders' ,'ui-rangeslider','ui-spinner','ui-sweetalerts','ui-nav-tabs','ui-toasts','ui-tooltips','ui-typography','ui-video') ? 'active' : '' }} " id="v-pills-baseui" role="tabpanel" aria-labelledby="v-pills-baseui-tab">
                    <p>Base UI</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('ui-ribbon','ui-clipboard','ui-drag-drop','ui-rangeslider','ui-rating','ui-text-editor','ui-counter','ui-scrollbar','ui-stickynote','ui-timeline') ? 'active' : '' }}" id="v-pills-elements" role="tabpanel" aria-labelledby="v-pills-elements-tab">
                    <p>Advanced UI</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('chart-apex','chart-js','chart-morris','chart-flot','chart-peity','chart-c3') ? 'active' : '' }}" id="v-pills-charts" role="tabpanel" aria-labelledby="v-pills-charts-tab">
                    <p>Charts</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('icon-fontawesome','icon-feather','icon-ionic','icon-material','icon-pe7','icon-simpleline','icon-themify','icon-weather','icon-typicon','icon-flag') ? 'active' : '' }}" id="v-pills-icons" role="tabpanel" aria-labelledby="v-pills-icons-tab">
                    <p>Icons</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('form-basic-inputs','form-input-groups','form-horizontal','form-vertical','form-mask','form-validation','form-select2','form-fileupload','horizontal-timeline','form-wizard') ? 'active' : '' }}" id="v-pills-forms" role="tabpanel" aria-labelledby="v-pills-forms-tab">
                    <p>Forms</p>
                    <ul>
                ...
                <div class="tab-pane fade show {{ Request::is('tables-basic','data-tables') ? 'active' : '' }}" id="v-pills-tables" role="tabpanel" aria-labelledby="v-pills-tables-tab">
                    <p>Tables</p>
                    <ul>
        ...
        <div class="sidebar-right">
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="v-pills-apps" role="tabpanel" aria-labelledby="v-pills-apps-tab">
                    ...
                    <ul>
                        <li>
                            <a  class="{{ Request::is('chat') ? 'active' : '' }}" href="{{url('chat')}}" class="active">Chat</a>
                        </li>
                        <li class="sub-menu">
                            <a href="#">Calls <span class="menu-arrow"></span></a>
                            <ul>
