...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0">Badges</h4>
                </div>
                <!-- end card header -->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0">Rounded Badges </h4>
                </div>
                <!-- end card header -->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0">Outline Rounded Badges </h4>
                </div>
                <!-- end card header -->
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0">Soft Rounded Badges </h4>
                </div>
                <!-- end card header -->
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0">Buttons With Badges</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0">Outline Buttons With Badges</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                    <div class="d-flex flex-wrap gap-2">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <span class="badge bg-secondary"><span class="badge-label">Secondary</span><i
                                    class="fa-solid fa-plus ms-1"></i></span>
                            <span class="badge bg-success"><span class="badge-label">Success</span><i
                                    class="fa-solid fa-check ms-1"></i></span>
                            <span class="badge bg-info"><span class="badge-label">Info</span><i
                                    class="fa-solid fa-circle-info ms-1"></i></span>
                            <span class="badge bg-warning"><span class="badge-label">Warning</span><i
                                    class="fa-solid fa-circle-info ms-1"></i></span>
                            <span class="badge bg-danger"><span class="badge-label">Danger</span><i
                                    class="fa-solid fa-x ms-1"></i></span>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <span class="badge bg-outline-secondary"><span class="badge-label">Secondary</span><i
                                    class="fa-solid fa-plus ms-1"></i></span>
                            <span class="badge bg-outline-success"><span class="badge-label">Success</span><i
                                    class="fa-solid fa-check ms-1"></i></span>
                            <span class="badge bg-outline-info"><span class="badge-label">Info</span><i
                                    class="fa-solid fa-circle-info ms-1"></i></span>
                            <span class="badge bg-outline-warning"><span class="badge-label">Warning</span><i
                                    class="fa-solid fa-circle-info ms-1"></i></span>
                            <span class="badge bg-outline-danger"><span class="badge-label">Danger</span><i
                                    class="fa-solid fa-x ms-1"></i></span>
                        </div>
                    </div>
                </div>
