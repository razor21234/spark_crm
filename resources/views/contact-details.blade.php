        ...
        <div class="col-md-12">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <ul class="contact-breadcrumb">
                            <li><a href="{{ url('contact-grid')}}"><i class="las la-arrow-left"></i> Contacts</a></li>
                    ...
                    <div class="col-sm-6 text-sm-end">
                        <div class="contact-pagination">
                            ...
                            <ul>
                                <li>
                                    <a href="{{ url('contact-details')}}"><i class="las la-arrow-left"></i></a>
                                </li>
                                <li>
                                    <a href="{{ url('contact-details')}}"><i class="las la-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="contact-wrap">
                ...
                <div class="contacts-action">
                    ...
                    <a href="#" class="btn-icon"  data-bs-toggle="modal" data-bs-target="#edit_contact"><i class="feather-edit"></i></a>	
                    <div class="dropdown">
        ...
        <div class="col-xl-3">
            <div class="card contact-sidebar">
                ...
                <ul class="company-info">
                    <li>
                        <span>
                            <img src="{{ URL::asset('assets/img/icons/google-icon.svg')}}" alt="Img">
                        </span>
                        <div>
                ...
                <ul class="set-info">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_contact"><i class="feather-trash-2"></i>Delete Contact</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="note-download">
                                            ...
                                            <a href="javascript:void(0);"><i class="las la-file-alt"></i></a>
                                        </div>
                                    </li>
                                </ul>
                                <div class="reply-box">
