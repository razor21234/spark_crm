            ...
            <div class="card bg-white">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-top nav-justified">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#top-justified-tab2" data-bs-toggle="tab">Profile</a>
                        </li>
            ...
            <div class="card bg-white">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="nav-item"><a class="nav-link active" href="#bottom-tab1" data-bs-toggle="tab">Home</a>
                        </li>
                ...
                <div class="card-body">
                    <nav class="nav nav-style-1 nav-pills mb-3" role="tablist">
                        ...
                        <a class="nav-link active" data-bs-toggle="tab" role="tab" href="#nav-cart"
                            aria-selected="true">Cart <span class="badge bg-secondary ms-1 rounded-pill">32</span></a>
                        <a class="nav-link" data-bs-toggle="tab" role="tab" href="#nav-orders"
                            aria-selected="false">Orders <span class="badge bg-success ms-1 rounded-pill">4</span></a>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="order-tab" data-bs-toggle="tab"
                                ...
                                aria-controls="home-tab-pane" aria-selected="true"><i
                                    class="fa-solid fa-gift me-1 align-middle"></i>Ordered</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="confirmed-tab" data-bs-toggle="tab"
                                ...
                                aria-controls="profile-tab-pane" aria-selected="false"><i
                                    class="fa-solid fa-check me-1 align-middle"></i>Confirmed</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="shipped-tab" data-bs-toggle="tab"
                                ...
                                aria-controls="contact-tab-pane" aria-selected="false"><i
                                    class="fa-solid fa-bag-shopping me-1 align-middle"></i>Shipped</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="delivered-tab" data-bs-toggle="tab"
                                data-bs-target="#delivered-tab-pane" type="button" role="tab"
                                aria-selected="false"><i class="fa-solid fa-truck me-1 align-middle"></i>Delivery</button>
                        </li>
                    </ul>
                ...
                <div class="card-body px-sm-4 px-2">
                    ...
                    <div class="tab-content" id="myTabContent1">
                        ...
                        <div class="tab-pane fade text-muted" id="profile-tab-pane" role="tabpanel"
                            ...
                            publishing packages as their default model text, and a search for <b>'lorem ipsum'</b> will over
                            the
                            years.</div>
                        <div class="tab-pane fade text-muted" id="contact-tab-pane" role="tabpanel"
                            aria-labelledby="contact-tab" tabindex="0">There, <b>by injected humour</b>, or randomised
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body px-sm-4 px-2">
                    ...
                    <div class="tab-content pt-0" id="tab-style-4">
                        ...
                        <div class="tab-pane" id="nav-contact1" role="tabpanel" aria-labelledby="nav-contact-tab"
                            tabindex="0">
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <span class="avatar avatar-sm">
                                                    <img src="{{ URL::asset('/assets/img/media/media-6.jpg') }}"
                                                        alt="img">
                                                </span>
                                            </th>
                                            <td>Shoes</td>
        ...
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-body d-flex align-items-start">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="nav flex-column nav-pills me-3 tab-style-7" id="v-pillss-tab" role="tablist"
                        ...
                        <div class="col-md-8">
                            <div class="tab-content pt-0" id="v-pillss-tabContent">
                                    ...
                                    <div class="d-sm-flex">
                                        ...
                                        <div>
                                            <div class="my-md-auto mt-4 ms-md-3">
                                                ...
                                                <p class="text-muted mb-0"><b>Lorem Ipsum</b> is simply dummy text of the
                                ...
                                <div class="tab-pane" id="man-password" role="tabpanel" tabindex="0">
                                    <ul class="list-unstyled text-muted mb-0">
                                        <li class="mb-2">Lorem Ipsum is simply dummy text of the printing and
                                            typesetting industry. Lorem Ipsum has been the industry's <b>standard dummy text
                                                ever since the 1500s</b>, when an unknown printer took a galley of type and
                                        ...
                                        <li class="mb-2">Contrary to popular belief, Lorem Ipsum is not simply random
                                            ...
                                            College in Virginia,</li>
                                        <li class="mb-0">There are many variations of passages of Lorem Ipsum available,
                                            but the majority have suffered alteration in some form.</li>
                                    </ul>
                                </div>
                                <div class="tab-pane" id="main-team" role="tabpanel" aria-labelledby="main-team-tab"
                                    ...
                                    <ul class="list-unstyled text-muted mb-0">
                                        <li class="mb-2">Contrary to popular belief, Lorem Ipsum is not simply random
                                            ...
                                            it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney
                                            College in Virginia,</li>
                                        <li class="mb-2">There are many variations of passages of Lorem Ipsum available,
                                            but the majority have suffered alteration in some form.
                                        </li>
                                        <li class="mb-0">Lorem Ipsum is simply dummy text of the printing and
                                            typesetting industry. Lorem Ipsum has been the industry's <b>standard dummy text
                                                ever since the 1500s</b>, when an unknown printer took a galley of type and
                                            scrambled it to make a type specimen book. It has survived not only five
                                            centuries, but also the leap into electronic typesetting, remaining essentially
                                ...
                                <div class="tab-pane" id="main-email" role="tabpanel"
                                    ...
                                    <ul class="list-unstyled text-muted mb-0">
                                        ...
                                        <li class="mb-0">How hotel deals can help you live a better life. <b>How
                                                celebrity cruises</b> aren't as bad as you think. How cultural solutions can
                                            help you predict the future. How to cheat at dog friendly hotels and get away
                                            with it. </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="tab-content pt-0">
                                <div class="tab-pane show active text-muted" id="home-vertical-custom"
                                    ...
                                    <ul class="mb-0">
                                        ...
                                        <li>How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                            aren't as bad as you think. How cultural solutions can help you predict the
                                            future. How to cheat at dog friendly hotels and get away with it.</li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-md-4">
                            <ul class="nav nav-tabs flex-column vertical-tabs-3" role="tablist">
                                <li class="nav-item me-0">
                                    <a class="nav-link active text-break mw-100" data-bs-toggle="tab" role="tab"
                                ...
                                <li class="nav-item me-0">
                                    <a class="nav-link text-break mw-100" data-bs-toggle="tab" role="tab"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-break mb-0 mw-100" data-bs-toggle="tab" role="tab"
                                ...
                                <div class="tab-pane text-muted" id="customers-vertical" role="tabpanel">
                                    <ul class="mb-0">
                                        <li class="mb-2">
                                            ...
                                            by English versions from the 1914 translation by H. Rackham,How hotel deals can
                                            help you live a better life. <b>How celebrity
                                                cruises</b>
                                        </li>
                                        <li>How hotel deals can help you live a better life. <b>How celebrity cruises</b>
                                            aren't as bad as you think. How cultural solutions can help you predict the
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-0">
                        <div class="tab-pane show active text-muted" id="hometab-dropdown" role="tabpanel">How travel
                            coupons make you a better lover. Why cultural solutions are the new black. Why mom was right
                            about travel insurances. How family trip ideas can helpyou predict the future. <b>How carnival
                                cruises make you a better lover</b>. Why you'll never succeed at daily deals. 11 ways
                            cheapest flights can find you the love of your life.</div>
                        <div class="tab-pane text-muted" id="homeabout-dropdown" role="tabpanel">
                            How hotel deals can help you live a better life. <b>How celebrity cruises</b> aren't as bad as
                            you think. How cultural solutions can help you predict the future. How to cheat at dog friendly
                            hotels and get away with it.
                        </div>
                        <div class="tab-pane text-muted" id="homeproducts-dropdown" role="tabpanel">Lorem Ipsum is
                            simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's
                            <b>standard dummy text ever since the 1500s</b>, when an unknown printer took a galley of type
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-0">
                        <div class="tab-pane show active text-muted" id="pill-products" role="tabpanel">
                            How travel coupons make you a better lover. Why cultural solutions are the new black. Why mom
                            was right about travel insurances. How family trip ideas can helpyou predict the future. <b>How
                                carnival cruises make you a better lover</b>. Why you'll never succeed at daily deals. 11
                            ways cheapest flights can find you the love of your life.
                        </div>
                        ...
                        <div class="tab-pane text-muted" id="pill-orders" role="tabpanel">Lorem Ipsum is simply dummy
                            text of the printing and typesetting industry. Lorem Ipsum has been the industry's <b>standard
                                dummy text ever since the 1500s</b>, when an unknown printer took a galley of type and
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-0">
                        <div class="tab-pane show active text-muted" id="fill-pill-home" role="tabpanel">
                            ...
                            was right about travel insurances. How family trip ideas can helpyou predict the future. <b>How
                                carnival cruises make you a better lover</b>. Why you'll never succeed at daily deals. 11
                            ways cheapest flights can find you the love of your life. The complete beginner's guide to
                            mission trips. If you read one article about cultural notes read this one. Why you shouldn't eat
                ...
                <div class="card-body">
                    <nav class="nav nav-pills flex-column flex-sm-row" role="tablist">
                        ...
                        <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" role="tab"
                            aria-current="page" href="#pill-flex-big" aria-selected="false">More Data More The Tab
                            Size</a>
                        <a class="flex-sm-fill text-sm-center nav-link" data-bs-toggle="tab" role="tab"
                    ...
                    <div class="tab-content mt-3 pt-0">
                        <div class="tab-pane show active text-muted" id="pill-flex-home" role="tabpanel"> How travel
                            coupons make you a better lover. Why cultural solutions are the new black. Why mom was right
                            about travel insurances. How family trip ideas can helpyou predict the future. <b>How carnival
                                cruises make you a better lover</b>. Why you'll never succeed at daily deals. 11 ways
                            cheapest flights can find you the love of your life. The complete beginner's guide to mission
                            trips. If you read one article about cultural notes read this one. Why you shouldn't eat
                            vacation package in bed.</div>
                        <div class="tab-pane text-muted" id="pill-flex-big" role="tabpanel">How hotel deals can help
                            you live a better life. <b>How celebrity cruises</b> aren't as bad as you think. How cultural
                            solutions can help you predict the future. How to cheat at dog friendly hotels and get away with
                            it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How
                            not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How
                            twitter can teach you about carnival cruises. How to start using cultural solutions.</div>
                        <div class="tab-pane text-muted" id="pill-flex-about" role="tabpanel"> Unbelievable healthy
                            snack success stories. 12 facts about safe food handling tips that will impress your friends.
                            Restaurant weeks by the numbers. Will mexican food ever rule the world? The 10 best thai
                            restaurant youtube videos. How restaurant weeks can make you sick. The complete beginner's guide
                            to cooking healthy food. Unbelievable food stamp success stories. How whole foods markets are
                            making the world a better place. 16 things that won't happen in dish reviews.</div>
                    </div>
                </div>
            </div>
        </div>
