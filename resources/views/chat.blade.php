                ...
                <div class="navbar">
                    <div class="user-details me-auto">
                        ...
                        <div class="user-info float-start">
                            <a href="{{ url('profile') }}" title="Mike Litorus"><span>Mike Litorus</span> <i
                    ...
                    <ul class="nav custom-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('voice-call') }}" class="nav-link"><i class="fa-solid fa-phone"></i></a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('video-call') }}" class="nav-link"><i class="fa-solid fa-video"></i></a>
                        </li>
                            ...
                            <div class="chats">
                                ...
                                <div class="chat chat-right">
                                    <div class="chat-body">
                                        ...
                                        <div class="chat-bubble">
                                            <div class="chat-content">
                                                <p>OK, my name is Limingqiang. I like singing, playing basketballand so on.
                                                </p>
                                                ...
                                                <div class="chat-img-group clearfix">
                                                    ...
                                                    <a class="chat-img-attach" href="#">
                                                        <img width="182" height="137"
                                                            src="{{ URL::asset('assets/img/placeholder.jpg') }}"
                ...
                <div class="message-bar">
                    <div class="message-inner">
                        <a class="link attach-icon" href="#" data-bs-toggle="modal"
                            data-bs-target="#drag_files"><img src="{{ URL::asset('assets/img/attachment.png') }}"
        ...
        <div class="chat-window video-window">
            <div class="fixed-header">
                <ul class="nav nav-tabs nav-tabs-bottom">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="#profile_tab" data-bs-toggle="tab">Profile</a>
                    </li>
                </ul>
            </div>
