                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="profile-info-left">
                                        ...
                                        <div class="staff-msg"><a href="{{ url('chat') }}" class="btn btn-custom">Send
                                                Message</a></div>
                                    </div>
                                </div>
                                <div class="col-md-7">
                        ...
                        <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="project-title"><a href="{{ url('project-view') }}">Project Management</a>
                                    </h4>
                                    <small class="block text-ellipsis m-b-15">
                        ...
                        <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="project-title"><a href="{{ url('project-view') }}">Video Calling App</a>
                                    </h4>
                                    <small class="block text-ellipsis m-b-15">
