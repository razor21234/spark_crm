        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-list">
                            <button type="button" class="btn btn-outline-primary me-1 btn-wave"
                                id="primaryToastBtn">Primary</button>
                            <button type="button" class="btn btn-outline-secondary me-1 btn-wave"
                                id="secondaryToastBtn">Secondary</button>
                            <button type="button" class="btn btn-outline-warning me-1 btn-wave"
                                id="warningToastBtn">Warning</button>
                            <button type="button" class="btn btn-outline-info me-1 btn-wave"
                                id="infoToastBtn">Info</button>
                            <button type="button" class="btn btn-outline-success me-1 btn-wave"
                                id="successToastBtn">Success</button>
                            <button type="button" class="btn btn-outline-danger me-1 btn-wave"
            ...
            <div class="col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-list">
                            <button type="button" class="btn btn-primary me-1 btn-wave"
                                id="solidprimaryToastBtn">Primary</button>
                            <button type="button" class="btn btn-secondary me-1 btn-wave"
                                id="solidsecondaryToastBtn">Secondary</button>
                            <button type="button" class="btn btn-warning me-1 btn-wave"
                                id="solidwarningToastBtn">Warning</button>
                            <button type="button" class="btn btn-info me-1 btn-wave"
                                id="solidinfoToastBtn">Info</button>
                            <button type="button" class="btn btn-success me-1 btn-wave"
                                id="solidsuccessToastBtn">Success</button>
                            <button type="button" class="btn btn-danger me-1 btn-wave"
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="btn-list">
                            <button type="button" class="btn btn-outline-primary me-1 btn-wave" id="topleftToastBtn">Top
                                Left</button>
                            <button type="button" class="btn btn-outline-primary me-1 btn-wave"
