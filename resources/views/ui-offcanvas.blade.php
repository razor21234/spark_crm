        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body card-buttons">
                    ...
                    <p>You can use a link with the <code>href</code> attribute, or a button with the
                        <code>data-bs-target</code> attribute. In both cases, the <code>data-bs-toggle="offcanvas"</code> is
                        required.
                    </p>

                    <div class="button-list">
                        <a class="btn btn-primary mt-1" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button"
                    ...
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
                        ...
                        <div class="offcanvas-header">
                            ...
                            <button type="button" class="btn-close text-reset mt-1" data-bs-dismiss="offcanvas"
            ...
            <div class="card">
                <div class="card-body card-buttons">
                    ...
                    <p>Scrolling the <code>&lt;body&gt;</code> element is disabled when an offcanvas and its backdrop are
                        visible. Use the <code>data-bs-scroll</code> attribute to toggle <code>&lt;body&gt;</code> scrolling
                        and <code>data-bs-backdrop</code> to toggle the backdrop.</p>
