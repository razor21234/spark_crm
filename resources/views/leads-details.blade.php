    ...
    <div class="row">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <ul class="contact-breadcrumb">
                            <li><a href="{{url('leads')}}"><i class="las la-arrow-left"></i> Leads</a></li>
                    ...
                    <div class="col-sm-6 text-sm-end">
                        <div class="contact-pagination">
                            ...
                            <ul>
                                <li>
                                    <a href="{{url('leads-details')}}"><i class="las la-arrow-left"></i></a>
                                </li>
                                <li>
                                    <a href="{{url('leads-details')}}"><i class="las la-arrow-right"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="col-xl-3">
            <div class="card contact-sidebar">
                        ...
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown"
                                aria-expanded="false"><span><i
                                        class="fa-solid fa-circle me-1 text-danger circle"></i>High</span><i
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <h5>Contacts</h5>
                    <a href="javascript:void(0);" class="com-add" data-bs-toggle="modal" data-bs-target="#add_contact"><i
                            class="las la-plus-circle me-1"></i>Add New</a>
                </div>
                <ul class="deals-info">
                    <li>
                        <span>
                ...
                <ul class="other-info">
                    ...
                    <li>
                        ...
                        <span><img src="{{ URL::asset('assets/img/avatar/avatar-19.jpg')}}" class="avatar-xs rounded-circle" alt="img">
                ...
                <div class="tab-content pt-0">
                                ...
                                <li class="activity-wrap">
                                    ...
                                    <div class="activity-info">
                                        <h6>Meeting With <span class="avatar-xs"><img
                                                    src="{{ URL::asset('assets/img/avatar/avatar-19.jpg')}}" alt="img"></span> Abraham
                                        </h6>
                            ...
                            <ul>
                                <li class="activity-wrap">
                                    ...
                                    <div class="activity-info">
                                        ...
                                        <p>A product team meeting is a gathering of the cross-functional product team —
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="dropdown">
                                                        <a href="#" class="dropdown-toggle"
                                                            data-bs-toggle="dropdown" aria-expanded="false"><i
                                                                class="las la-clock me-1"></i>Reminder<i
                                                                class="las la-angle-down ms-1"></i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="dropdown">
                                                        <a href="#" class="dropdown-toggle"
                                                            data-bs-toggle="dropdown" aria-expanded="false"><i
                                                                class="fa-solid fa-circle me-1 text-danger circle"></i>High<i
                                                                class="las la-angle-down ms-1"></i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="javascript:void(0);"><i
                                                                    class="fa-solid fa-circle me-1 text-danger circle"></i>High</a>
                                                            <a class="dropdown-item" href="javascript:void(0);"><i
                                                                    class="fa-solid fa-circle me-1 text-success circle"></i>Low</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="dropdown">
                                                        <a href="#" class="dropdown-toggle"
                                                            data-bs-toggle="dropdown" aria-expanded="false"><img
                                                                src="{{ URL::asset('assets/img/avatar/avatar-19.jpg')}}" alt="img"
                                                                class="me-1 avatar-xs">John<i
                                                                class="las la-angle-down ms-1"></i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="javascript:void(0);"><img
                                                                    src="{{ URL::asset('assets/img/avatar/avatar-19.jpg')}}" alt="img"
                                                                    class="me-1 avatar-xs">John</a>
                                                            <a class="dropdown-item" href="javascript:void(0);"><img
                                                                    src="{{ URL::asset('assets/img/avatar/avatar-19.jpg')}}" alt="img"
                                                                    class="me-1 avatar-xs">Peter</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_notes"
                                        class="com-add"><i class="las la-plus-circle me-1"></i>Add New</a>
                                </li>
                            </ul>
                        </div>
                        <div class="notes-activity">
                            <div class="calls-box">
                                <div class="caller-info">
                                    ...
                                    <div class="calls-action">
                                        <div class="dropdown action-drop">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="javascript:void(0);"><i
                                                        class="las la-edit me-1"></i>Edit</a>
                                                <a class="dropdown-item" href="javascript:void(0);"><i
                                                        class="las la-trash me-1"></i>Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <p>A project review evaluates the success of an initiative and identifies areas for
                                    improvement. It can also evaluate a current project to determine whether it's on the
                                    right track. Or, it can determine the success of a completed project. </p>
                                <ul>
                                    <li>
                                ...
                                <div class="notes-editor">
                                    <div class="note-edit-wrap">
                                        <div class="summernote">Write a new comment, send your team notification by typing
                                            @ followed by their name</div>
                                    ...
                                    <div class="text-end">
                                        <a href="javascript:void(0);" class="add-comment"><i
                                                class="las la-plus-circle me-1"></i>Add Comment</a>
                                    </div>
                                </div>
                            </div>
                            <div class="calls-box">
                                ...
                                <h5>Notes added by Antony</h5>
                                <p>A project plan typically contains a list of the essential elements of a project, such as
                                    stakeholders, scope, timelines, estimated cost and communication methods. The project
                                    manager typically lists the information based on the assignment.</p>
                                <ul>
                                    <li>
                                        <div class="note-download">
                                            <div class="note-info">
                                ...
                                <div class="reply-box">
                                    <p>The best way to get a project done faster is to start sooner. A goal without a
                                        timeline is just a dream.The goal you set must be challenging. At the same time, it
                                        should be realistic and attainable, not impossible to reach.</p>
                            ...
                            <div class="calls-box">
                                ...
                                <p>Projects play a crucial role in the success of organizations, and their importance cannot
                                    be overstated. Whether it's launching a new product, improving an existing</p>
                                <div class="notes-editor">
                                    <div class="note-edit-wrap">
                                        <div class="summernote">Write a new comment, send your team notification by typing
                                            @ followed by their name</div>
                        ...
                        <div class="calls-activity">
                                ...
                                <div class="caller-info">
                                    ...
                                    <div class="calls-action">
                                        <div class="dropdown call-drop">
                                            <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown"
                                                aria-expanded="false">Busy<i class="las la-angle-down ms-1"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="calls-box">
                                <div class="caller-info">
                                    ...
                                    <div class="calls-action">
                                        <div class="dropdown call-drop">
                                            <a href="#" class="dropdown-toggle bg-light-pending"
                                                data-bs-toggle="dropdown" aria-expanded="false">No Answer<i
                                                    class="las la-angle-down ms-1"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="javascript:void(0);">Busy</a>
                                                <a class="dropdown-item" href="javascript:void(0);">No Answer</a>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-md-end">
                                        <ul class="file-action">
                                            ...
                                            <li>
                                                <span class="badge badge-soft-grey priority-badge"><i
                                                        class="fa-solid fa-circle"></i>Low</span>
                                            </li>
                                            <li>
                                                <div class="dropdown action-drop">
                                                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a class="dropdown-item" href="javascript:void(0);"><i
                                                                class="las la-trash me-1"></i>Delete</a>
                                                        <a class="dropdown-item" href="javascript:void(0);"><i
                                                                class="las la-download me-1"></i>Download</a>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-md-end">
                                        <ul class="file-action">
                                            ...
                                            <li>
                                                <span class="badge badge-soft-success priority-badge"><i
                                                        class="fa-solid fa-circle"></i>Sent</span>
                                            </li>
                                            <li>
                                                <div class="dropdown action-drop">
                                                    <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown"
                    ...
                    <div class="tab-pane fade" id="email">
                        <div class="view-header">
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0);" class="com-add create-mail" data-bs-toggle="tooltip"
                                        data-bs-placement="left" data-bs-custom-class="tooltip-dark"
                                        data-bs-original-title="There are no email accounts configured, Please configured your email account in order to Send/ Create EMails"><i
                                            class="las la-plus-circle me-1"></i>Create Email</a>
                                </li>
                            </ul>
                        </div>
                        <div class="files-activity">
