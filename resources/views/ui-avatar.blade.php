    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body d-flex flex-wrap gap-2">
                    ...
                    <span class="avatar avatar-xl me-2 border-thumb">
                        <img src="{{ URL::asset('/assets/img/profiles/avatar-02.jpg') }}" alt="img">
                    </span>
                    ...
                    <span class="avatar avatar-xl bg-danger border-thumb">
                        <span class="avatar-title">SR</span>
                    </span>
                </div>
            </div>
        ...
        <div class="col-xl-6">
            <div class="card bg-white">
                ...
                <div class="card-body border-thumb">
        ...
        <div class="col-xl-6">
            <div class="card">
                ...
                <div class="card-body">
                    <span class="avatar bg-soft-primary avatar-rounded">
                        <span class="avatar-title">SR</span>
                    </span>
                ...
                <div class="card-body">
                    <div class="avatar-list-stacked avatar-group-lg mb-4">
                        <span class="avatar avatar-rounded">
                            <img class="border border-white" src="{{ URL::asset('/assets/img/profiles/avatar-05.jpg') }}"
                                alt="img">
                        </span>
                        <span class="avatar avatar-rounded">
                            <img class="border border-white" src="{{ URL::asset('/assets/img/profiles/avatar-05.jpg') }}"
