        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="sub-header">You can also add the indicators to the carousel, alongside the controls, too.</p>
                </div>
                <div class="card-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img src="{{ URL::asset('/assets/img/img-1.jpg') }}" alt="Slide"
                            ...
                            <div class="carousel-item">
                                <img src="{{ URL::asset('/assets/img/img-2.jpg') }}" alt="Slide"
                                    class="d-block img-fluid">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item">
                                <img src="{{ URL::asset('/assets/img/img-3.jpg') }}" alt="Slide"
                                    class="d-block img-fluid">
                                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ URL::asset('/assets/img/img-2.jpg') }}" class="d-block w-100"
                                    alt="Slide">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ URL::asset('/assets/img/img-3.jpg') }}" class="d-block w-100"
                                    alt="Slide">
                            </div>
                            <div class="carousel-item">
                                <img src="{{ URL::asset('/assets/img/img-4.jpg') }}" class="d-block w-100"
                                    alt="Slide">
                            </div>
                        </div>
