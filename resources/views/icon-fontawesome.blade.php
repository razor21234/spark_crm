                ...
                <div class="card-body">
                    <div class="icons-items">
                        <ul class="icons-list">
                            ...
                            <li><i class="fa fa-align-justify" data-bs-toggle="tooltip" title="fa fa-align-justify"></i>
                            </li>
                            ...
                            <li><i class="fa fa-angle-double-up" data-bs-toggle="tooltip" title="fa fa-angle-double-up"></i>
                            </li>
                            ...
                            <li><i class="fa fa-arrow-circle-up" data-bs-toggle="tooltip" title="fa fa-arrow-circle-up"></i>
                            </li>
                            ...
                            <li><i class="fa fa-balance-scale" data-bs-toggle="tooltip" title="fa fa-balance-scale"></i>
                            </li>
                            ...
                            <li><i class="fa fa-battery-empty" data-bs-toggle="tooltip" title="fa fa-battery-empty"></i>
                            </li>
                            <li><i class="fa fa-battery-full" data-bs-toggle="tooltip" title="fa fa-battery-full"></i>
                            </li>
                            <li><i class="fa fa-battery-half" data-bs-toggle="tooltip" title="fa fa-battery-half"></i>
                            </li>
                            ...
                            <li><i class="fa fa-birthday-cake" data-bs-toggle="tooltip" title="fa fa-birthday-cake"></i>
                            </li>
                            ...
                            <li><i class="fa fa-camera-retro" data-bs-toggle="tooltip" title="fa fa-camera-retro"></i>
                            </li>
                            ...
                            <li><i class="fa fa-check-circle" data-bs-toggle="tooltip" title="fa fa-check-circle"></i>
                            </li>
                            ...
                            <li><i class="fa fa-chevron-down" data-bs-toggle="tooltip" title="fa fa-chevron-down"></i>
                            </li>
                            <li><i class="fa fa-chevron-left" data-bs-toggle="tooltip" title="fa fa-chevron-left"></i>
                            </li>
                            <li><i class="fa fa-chevron-right" data-bs-toggle="tooltip" title="fa fa-chevron-right"></i>
                            </li>
                            ...
                            <li><i class="fa fa-envelope-open" data-bs-toggle="tooltip" title="fa fa-envelope-open"></i>
                            </li>
                            ...
                            <li><i class="fa fa-fast-backward" data-bs-toggle="tooltip" title="fa fa-fast-backward"></i>
                            </li>
                            <li><i class="fa fa-fast-forward" data-bs-toggle="tooltip" title="fa fa-fast-forward"></i>
                            </li>
                            ...
                            <li><i class="fa fa-search-minus" data-bs-toggle="tooltip" title="fa fa-search-minus"></i>
                            </li>
                            ...
                            <li><i class="fa fa-share-square" data-bs-toggle="tooltip" title="fa fa-share-square"></i>
                            </li>
                            <li><i class="fa fa-ship" data-bs-toggle="tooltip" title="fa fa-ship"></i></li>
                            <li><i class="fa fa-shopping-bag" data-bs-toggle="tooltip" title="fa fa-shopping-bag"></i>
                            </li>
                            <li><i class="fa fa-shopping-basket" data-bs-toggle="tooltip"
                                    title="fa fa-shopping-basket"></i></li>
                            <li><i class="fa fa-shopping-cart" data-bs-toggle="tooltip" title="fa fa-shopping-cart"></i>
                            </li>
                            <li><i class="fa fa-shower" data-bs-toggle="tooltip" title="fa fa-shower"></i></li>
                            <li><i class="fa fa-sign-language" data-bs-toggle="tooltip" title="fa fa-sign-language"></i>
                            </li>
                            ...
                            <li><i class="fa fa-step-backward" data-bs-toggle="tooltip" title="fa fa-step-backward"></i>
                            </li>
                            <li><i class="fa fa-step-forward" data-bs-toggle="tooltip" title="fa fa-step-forward"></i>
                            </li>
                            ...
                            <li><i class="fa fa-times-circle" data-bs-toggle="tooltip" title="fa fa-times-circle"></i>
                            </li>
                            ...
                            <li><i class="fa fa-venus-double" data-bs-toggle="tooltip" title="fa fa-venus-double"></i>
                            </li>
                            ...
                            <li><i class="fa fa-window-close" data-bs-toggle="tooltip" title="fa fa-window-close"></i>
                            </li>
