        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add <code>.btn-lg</code>, <code>.btn-sm</code>, or <code>.btn-xs</code> for
                        additional sizes.</p>
                </div>
                <div class="card-body">
                    <div class="btn-list">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0"> Add the <code>disabled</code> attribute to <code>&lt;button&gt;</code>
                        buttons.</p>
                </div>
                <div class="card-body">
                    <div class="btn-list">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Use a classes <code>.btn-icon</code> to quickly create a bordered buttons.
                    </p>
                </div>
                <div class="card-body">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Create block level buttons by adding class <code>.d-grid</code> to parent
                        div.</p>
                </div>
                <div class="card-body">
