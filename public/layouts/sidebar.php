        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <nav class="greedys sidebar-horizantal">
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a class="<?php echo ($page == 'chat.php')?'active':'';?>" href="chat.php">Chat</a></li>
                            <li class="submenu">
                    ...
                    <li class="submenu"> 
									...
									<ul>
										...
										<li>
											<a class="<?php echo ($page == 'deals.php' || $page == 'deals-kanban.php')?'active':'';?>" href="deals.php">  Deals</a>
										</li>
										<li>
											<a class="<?php echo ($page == 'leads.php' || $page == 'leads-kanban.php')?'active':'';?>" href="leads.php"> Leads </a>
										</li>
										<li>
										...
										<li>
											<a class="<?php echo ($page == 'activities.php')?'active':'';?>" href="activities.php"> Activities </a>
										</li>
									</ul>
					</li>
                    <li class="<?php echo ($page == 'tickets.php' || $page == 'ticket-details.php')?'active':'';?>"> 
                        ...
                        <ul>
							...
							<li><a class="<?php echo ($page == 'ticket-details.php')?'active':'';?>" href="ticket-details.php">Tickets Detail</a></li>
						</ul>
                    </li>
                    <li class="menu-title"> 
                        <span>HR</span>
                ...
                <ul class="hidden-links hidden">
                    ...
                    <li class="menu-title"> 
								...
								<li class="submenu">
									...
									<ul>
										...
										<li><a class="<?php echo ($page == 'ui-accordion.php')?'active':'';?>" href="ui-accordion.php">Accordions</a></li>
										...
										<li><a class="<?php echo ($page == 'ui-cards.php')?'active':'';?>" href="ui-cards.php">Cards</a></li>
										...
										<li><a class="<?php echo ($page == 'ui-popovers.php')?'active':'';?>" href="ui-popovers.php">Popover</a></li>                                    
										<li><a class="<?php echo ($page == 'ui-progress.php')?'active':'';?>" href="ui-progress.php">Progress Bars</a></li>
										...
										<li><a class="<?php echo ($page == 'ui-tooltips.php')?'active':'';?>" href="ui-tooltips.php">Tooltip</a></li>
                    ...
                    <li> 
                        <a href="javascript:void(0);"><i class="la la-info"></i> <span>Change Log</span> <span class="badge badge-primary ms-auto">v4.0.1</span></a>
                    </li>
                    <li class="submenu">
            ...
            <ul class="sidebar-vertical">
                ...
                <li class="menu-title"> 
                            ...
                            <li class="<?php echo ($page == 'contact-list.php' || $page == 'contact-grid.php' || $page == 'contact-details.php')?'active':'';?>">
								<a href="contact-list.php"><i class="la la-user-shield"></i> <span> Contacts </span></a>
							</li>
							<li class="<?php echo ($page == 'companies.php' || $page == 'companies-grid.php' || $page == 'company-details.php')?'active':'';?>">
								<a href="companies.php"><i class="la la-building"></i> <span> Companies </span></a>
							</li>
							<li class="<?php echo ($page == 'deals.php' || $page == 'deals-kanban.php')?'active':'';?>">
								<a href="deals.php"><i class="la la-cubes"></i> <span> Deals </span></a>
							</li>
							<li class="<?php echo ($page == 'leads.php' || $page == 'leads-kanban.php')?'active':'';?>">
								<a href="leads.php"><i class="la la-chart-area"></i> <span> Leads </span></a>
							</li>
							<li class="<?php echo ($page == 'pipeline.php')?'active':'';?>">
								<a href="pipeline.php"><i class="la la-exchange-alt"></i> <span> Pipeline </span></a>
							</li>
							<li class="<?php echo ($page == 'analytics.php')?'active':'';?>">
								<a href="analytics.php"><i class="la la-dice"></i> <span> Analytics </span></a>
							</li>
							<li class="<?php echo ($page == 'activities.php')?'active':'';?>">
								<a href="activities.php"><i class="la la-directions"></i> <span> Activities </span></a>
							</li>
                <li class="menu-title"> 
                    <span>HR</span>
                </li>
                ...
                <li class="<?php echo ($page == 'promotion.php')?'active':'';?>"><a href="promotion.php"><i class="la la-bullhorn"></i> <span>Promotion</span></a></li>
                <li class="submenu">
								<a class="<?php echo ($page == 'resignation.php')?'active':'';?>" href="resignation.php"><i class="la la-external-link-square"></i> <span>Resignation</span><span class="menu-arrow"></span></a>
                                <ul>
                ...
                <li class="menu-title"> 
								...
								<li class="submenu">
									<a href="ui-#"><i class="la la-dropbox"></i> <span> Elements </span> <span class="menu-arrow"></span></a>
									<ul>
										<li><a class="<?php echo ($page == 'ui-ribbon.php')?'active':'';?>" href="ui-ribbon.php">Ribbon</a></li>
										<li><a class="<?php echo ($page == 'ui-clipboard.php')?'active':'';?>" href="ui-clipboard.php">Clipboard</a></li>
										<li><a class="<?php echo ($page == 'ui-drag-drop.php')?'active':'';?>"href="ui-drag-drop.php">Drag & Drop</a></li>
